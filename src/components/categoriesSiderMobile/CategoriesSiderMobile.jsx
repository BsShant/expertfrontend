...
import './styles.css'
import { setSelectedCategory, triggerMobileSliderCollapse } from '../../store/categoryReducer/categoryStore.actions';
const CategoriesSiderMobile = (props) => {
    const { Sider } = Layout;
    ...
    const handleClick = (e) => {
       ...
       dispatch(triggerMobileSliderCollapse())
    }
    return (
...
export default CategoriesSiderMobile